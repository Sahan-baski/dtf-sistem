...
const SiparisSchema = new Schema({
  ...
  musteri_soyadi:   String, musteri_telefon:String, musteri_adres:String,
  musteri_user_id:  String,
  urunler:          [{ ad:String, adet:Number, fiyat:Number }],
  notlar:           String, teslim_tarihi:String,
  ...
  odeme: { tutar:{type:Number,default:0}, odenen:{type:Number,default:0}, odendi:{type:Boolean,default:false}, yontem:String, fatura_kesildi:{type:Boolean,default:false}, odeme_tarihi:String, notlar:String },
...
const AyarSchema = new Schema({ anahtar:{type:String,unique:true}, deger:Schema.Types.Mixed });

const KategoriSchema = new Schema({
  key:{type:String,required:true,unique:true}, label:{type:String,required:true},
  grup:{type:String,default:'Genel'}, renk:{type:String,default:'#4f7ef8'},
  sistem:{type:Boolean,default:false}, sira:{type:Number,default:0}, aktif:{type:Boolean,default:true},
}, { timestamps:true });
